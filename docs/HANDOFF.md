...
성과를 한 줄로: **디코드 37.6 → 74.2 tok/s(2박스, 2.07×) / 프리필 440 → 755 tok/s(1.72×)**,
...
| **2박스 층-파이프(bitwise 동일)** | **755** (1.72×@8K, 1.88×@32K, mlx 0.32.1 재측정) |
...
# 2박스 층-파이프 프리필(755 tok/s) — epsilon 러너 먼저
